                ...
                <div className="space-y-8">
                    <Tabs defaultValue="upload" className="w-full">
                        <div className="flex justify-center mb-8">
                            <TabsList className="inline-flex h-10 items-center justify-center rounded-full p-1 text-gray-500">
                                <TabsTrigger
                                    value="upload"
                                    className="inline-flex items-center justify-center whitespace-nowrap rounded-full px-4 py-2 text-sm font-medium ring-offset-white transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-white data-[state=active]:text-gray-950 data-[state=active]:shadow-sm gap-2"
                                >
                                        ...
                                        {uploadedImage ? (
                                            <div className="space-y-4">
                                                ...
                                                <Button
                                                    ...
                                                    className="text-white h-9 px-4 text-sm font-medium"
                                                >
                                                    Generate Favicons
                                                </Button>
                                            </div>
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                        ...
                                        <div className="flex flex-col items-center justify-center space-y-6">
                                            ...
                                            <Alert variant="default">
                                                <AlertCircleIcon />
                                                <AlertTitle>Hey please notice!</AlertTitle>
                                                <AlertDescription>
                                                    The result will not include the border. The border
                                                    just for preview neeeded.
                                                </AlertDescription>
                                            </Alert>
                                            ...
                                            <Button
                                                ...
                                                disabled={!letter}
                                                className="bg-secondary text-white hover:bg-primary/10 h-9 px-4 text-sm font-medium w-full"
                                            >
                                                Generate Favicons
                                            </Button>
                                        </div>
                        ...
                        <Card className="border border-gray-200 shadow-sm animate-in fade-in-50 slide-in-from-bottom-5 duration-500">
                            <CardHeader className="pb-4">
                                <div className="flex items-center justify-between">
                                    ...
                                    <Button
                                        onClick={downloadAll}
                                        className="bg-black hover:bg-zinc-800 text-white h-9 px-4 text-sm font-medium flex items-center gap-2"
                                    >
                            ...
                            <CardContent>
                                <div className="grid grid-cols-3 md:grid-cols-6 gap-4">
                                    {generatedFavicons.map((favicon, index) => (
                                        <div
                                            key={favicon.size}
                                            className="flex flex-col items-center space-y-3 p-4 border border-gray-200 rounded-lg hover:bg-zinc-800 cursor-pointer transition-all animate-in fade-in-0 slide-in-from-bottom-3"
